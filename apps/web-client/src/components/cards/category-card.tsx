...
export const CategoryCard = ({ category }: CategoryItemProps) => (
  <Link
    ...
    className="rounded-2xl p-3 text-center ring-2 ring-base-300 transition-shadow transition-colors ease-in-out hover:bg-orange-50 hover:ring-primary-focus hover:ring-offset-2"
  >
    <img
