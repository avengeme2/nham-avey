// base on https://github.com/headzoo/react-moment
// copied here bcuz of vite import error
...
const parseTypes = [PropTypes.string, PropTypes.array]

const calendarTypes = [PropTypes.object, PropTypes.bool]

const trimTypes = [PropTypes.string, PropTypes.bool]
...
export default class Moment extends React.Component {
  ...
  static getContent(props) {
    ...
    const fromNowPeriod =
      Boolean(fromNowDuring) && -datetime.diff(moment()) < fromNowDuring
    let content = ''
